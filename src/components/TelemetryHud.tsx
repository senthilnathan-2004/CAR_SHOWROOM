...
export default function TelemetryHud({ containerRef }: TelemetryHudProps) {
  ...
  useMotionValueEvent(scrollYProgress, 'change', (latest) => {
    ...
    if (latest < 0.15) {
      ...
      setStatusColor('#FF0033'); // Aggressive crimson
    } else if (latest < 0.65) {
      setStatus('POWERTRAIN SHIFT');
      setStatusColor('#FF0033');
    } else if (latest < 0.85) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 select-none pointer-events-none hidden sm:block">
      {/* Opaque solid background (bg-black/95) to hide the watermark logo underneath */}
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="relative w-8 h-8 rounded-full border border-white/10 flex items-center justify-center overflow-hidden">
              ...
              <motion.div
                ...
                className="w-full h-[1px] bg-gradient-to-r from-transparent via-[#FF0033]/80 to-[#FF0033] origin-center"
              />
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col space-y-1">
            ...
            <div className="flex items-baseline space-x-1">
              ...
              <span className="text-[10px] font-semibold text-[#FF0033] tracking-wider">KM/H</span>
            </div>
          </div>
          ...
          <div className="flex flex-col space-y-1">
            ...
            <div className="flex items-baseline space-x-1">
              ...
              <span className="text-[10px] font-semibold text-[#00D6FF] tracking-wider">DEG</span>
            </div>
          </div>
        </div>
          ...
          <div className="flex space-x-1 px-2 flex-grow justify-center">
            {[...Array(10)].map((_, i) => (
              <motion.div
                ...
                className="w-1.5 h-1 bg-[#FF0033] rounded-sm"
              />
            ))}
          </div>
          <span>MAX</span>
